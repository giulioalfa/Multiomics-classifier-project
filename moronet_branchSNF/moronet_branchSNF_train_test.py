...
def gen_trte_adj_mat(data_tr_list, data_trte_list, trte_idx, adj_parameter, fused_snf_train, fused_snf_test):
...
def train_test(data_folder, view_list, num_class,
    ...
    if data_folder == dataset_path +'GDCDATASET_N' or data_folder == dataset_path + "LuadLusc100":
        adj_parameter = 10
        dim_he_list = [400,400,200]
    ...
    adj_tr_list, adj_te_list = gen_trte_adj_mat(data_tr_list, data_trte_list, trte_idx, adj_parameter, fused_snf_train, fused_snf_test)
