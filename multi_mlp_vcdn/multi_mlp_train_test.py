...
from multi_mlp_models import init_model_dict, init_optim
...
# train and test dateset and labels loaing
...
def train_test(data_folder, view_list, num_class,
    ...
    print("data tr shape :", data_tr_list[0].shape,data_tr_list[1].shape, data_tr_list[2].shape)
    ...
    for epoch in range(num_epoch+1):
        ...
        if epoch % test_inverval == 0:
            te_prob = test_epoch(data_trte_list, trte_idx["te"], model_dict)
